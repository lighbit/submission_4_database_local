...
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_FIRST_AIR_DATE;
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_OVERVIEW;
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_PHOTO;
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_TABLE_NAME;
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_TITLE;
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_VOTE_AVARAGE;
import static com.example.submission3_zulkaranen.database.DatabaseContract.TVFavColumns.TV_VOTE_COUNT;
    ...
    public ArrayList<TvShow> getAllTvFavorite() {
        ...
        if (cursor.getCount() > 0) {
            do {
                ...
                tvShowFavorite.setPopularity(cursor.getString(cursor.getColumnIndexOrThrow(TV_TITLE)));
